...
<DATABASE_MODELS>
This is a B2B app with organizations support: [organization.ts](mdc:src/db/schema/organization.ts) [organization-membership.ts](mdc:src/db/schema/organization-membership.ts) [organization-invites.ts](mdc:src/db/schema/organization-invites.ts) [withOrganizationAuthRequired.ts](mdc:src/lib/auth/withOrganizationAuthRequired.ts) [useOrganization.ts](mdc:src/lib/organizations/useOrganization.ts)

Refer to those models while building organization specific views (hook for frontend, route wrapper for backend)
</DATABASE_MODELS>
