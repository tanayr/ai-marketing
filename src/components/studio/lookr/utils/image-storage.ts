/**
 * Utility for managing temporary product images in local storage
 * for the Lookr Studio
 */

// Local storage keys
const STORAGE_KEY_PREFIX = 'lookr_temp_img_';
const STORAGE_INDEX_KEY = 'lookr_temp_img_index';
 ...
 */
export const saveImageToLocalStorage = (dataUrl: string, name: string = 'product'): LocalImage => {
